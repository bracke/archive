...
Unsupported ZIP encryption modes, including strong encryption and AES
extra-field encryption, remain visible but unavailable until a dedicated
decrypting backend is added.
