...
| CAB stored | supported | supported | supported | supported | archive CAB adapter |
...
encrypted entries outside supported 7z layouts, compressed CAB folders, ZIP
PPMd, and unsupported ZIP methods or 7z layouts.
