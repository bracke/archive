   ...
   begin
      case Format is
         when Archive.Archives.Formats.Zip_Format =>
            ...
            elsif Method = Zip_Deflate_Method then
               if Source_Path = "" then
         ...
         when Archive.Archives.Formats.Ar_Format =>
            return Archive.Writes.Execution.Publish_Ar
              (Destination_Path, Plan,
               Source_Path => Source_Path,
               Overwrite => Overwrite,
               Cancelled => Cancelled);
         ...
         when Archive.Archives.Formats.Cab_Format =>
            return Archive.Writes.Execution.Publish_Cab
              (Destination_Path, Plan,
               Source_Path => Source_Path,
               Overwrite => Overwrite,
               Cancelled => Cancelled);
         ...
         when Archive.Archives.Formats.Iso_Format =>
            return Archive.Writes.Execution.Publish_Iso
              (Destination_Path, Plan,
               Source_Path => Source_Path,
               Overwrite => Overwrite,
               Cancelled => Cancelled);
